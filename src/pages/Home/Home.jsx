...
const Home = () => {
  return (
    <>
      <div>
        <div className="hero h-screen " style={{ backgroundImage: `url("https://images.unsplash.com/photo-1565650834520-0b48a5c83f43?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2011&q=80")` }}>
          <div className="hero-overlay bg-opacity-30"></div>
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              <h1 className="mb-5 text-5xl font-bold">Welcome To <br /> <span className='text-blue-600'>The</span> <span className='text-blue-600'>Golden</span></h1>
              <p className="mb-5">
      ...
      <div className='grid grid-rows-1 lg:grid-cols-2 md:grid-cols-2  my-20 p-10 bg-blue-500 rounded-xl'>
          ...
          <div className="items-center flex flex-wrap">
            ...
            <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div className="md:pr-12">
                <div
                  className="text-pink-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-blue-300"
                >
